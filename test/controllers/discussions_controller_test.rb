...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { comment: @discussion.comment, name: @discussion.name, subject: @discussion.subject }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { comment: @discussion.comment, name: @discussion.name, subject: @discussion.subject }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
